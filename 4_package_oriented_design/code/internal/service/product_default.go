...
func (p *ProductDefault) FindAllProducts() (products map[int]internal.Product, err error) {
...
func (p *ProductDefault) FindProductsFilteredByPrice(priceGt float64) (products map[int]internal.Product, err error) {
